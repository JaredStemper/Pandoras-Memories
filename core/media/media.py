...
def update_image(dt, sprite, image_paths):
...
def MainLoop(logger):
    ...
    pyglet.clock.schedule_interval(update_image, 6.0, sprite, image_paths)
    # pyglet.clock.schedule_interval(update_pan, 0/60.0, sprite)
    # pyglet.clock.schedule_interval(update_zoom, 0/60.0, sprite)
